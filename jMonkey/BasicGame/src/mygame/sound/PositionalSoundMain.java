 ...
 * @author qinghai
 */
public class PositionalSoundMain extends SimpleApplication {
...
//        rootNode.addLight(ambient);
    ...
    private void loadSounds() {
        ...
        AudioNode riverAudio = new AudioNode(assetManager, "Sounds/Environment/River.ogg");
        riverAudio.setPositional(true);
        riverAudio.setRefDistance(1f);
        riverAudio.setMaxDistance(5000000f);
        riverAudio.setVolume(0.2f);
        riverAudio.setLooping(true);
        riverAudio.setLocalTranslation(0, 0, 0);
        
        jaimeNode.attachChild(riverAudio);
        riverAudio.play();
        
//        audiolistener = new Listener();
//        audiolistener.setRenderer(audioRenderer);
    }
    ...
    public static void main(String[] args) {
        ...
        PositionalSoundMain app = new PositionalSoundMain();
