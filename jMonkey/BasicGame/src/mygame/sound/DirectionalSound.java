...
public class DirectionalSound extends SimpleApplication {
  ...
  public void simpleInitApp() {
    ...
    riverAudio.setRefDistance(0.5f);   // Distance of 50% volume
    riverAudio.setMaxDistance(1000f); // Distance where it stops going quieter
    riverAudio.setDirectional(true);
    riverAudio.setInnerAngle(50);
    riverAudio.setOuterAngle(120);
    riverAudio.setDirection(Vector3f.UNIT_Z);
