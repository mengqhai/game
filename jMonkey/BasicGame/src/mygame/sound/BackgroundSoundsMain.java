 ...
 * @author qinghai
 */
public class BackgroundSoundsMain extends SimpleApplication {
...
//        rootNode.addLight(ambient);
    ...
    private void loadSounds() {
        AudioNode natureAudio = new AudioNode(assetManager, "Sounds/Environment/River.ogg");
    ...
    public static void main(String[] args) {
        ...
        BackgroundSoundsMain app = new BackgroundSoundsMain();
